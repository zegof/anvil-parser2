...
# supported versions for writing, reading should work for all versions
class VERSIONS(IntEnum):
    ...
    # This version changes Maximum buiding height in Overworld to 319 and minimum height has been dropped to -64, making chunks 384 blocks high in total.
    # https://minecraft.wiki/w/Chunk?oldid=3359203#:~:text=21w06a,total&text=Experimental,high
    # also known as 1_18_experimental-snapshot-1
    VERSION_EXPERIMENTAL_SNAPSHOT_1 = 2825
